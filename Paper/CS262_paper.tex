...
Jonah Brown-Cohen\\
       ...
       \affaddr{jonahbc@cs.berkeley.edu}
% 2nd. author
\alignauthor
Tselil Schramm\\
       \affaddr{U.C. Berkeley}\\
       \affaddr{tschramm@cs.berkeley.edu}
% 3rd. author
\alignauthor 
Ben Weitz\\
       \affaddr{U.C. Berkeley}\\
       \affaddr{bsweitz@cs.berkeley.edu}
}
...
\category{D.2.8}{Computer Systems}{Metrics}[complexity measures, performance measures]

\terms{Theory}

\keywords{Parameter Selection, Adaptive Computing, Machine Learning} % NOT required for Proceedings
...
\bibliography{CS262_paper}  % sigproc.bib is the name of the Bibliography in this case
